---
lang: en-us
title: Day 12 - Advent of Code 2025
---
...
You don\'t have enough stars to finish decorating the North Pole,
though. You need 13 more.

Although it hasn\'t changed, you can still [get your puzzle
input](12/input){target="_blank"}.

You can [\[Share[on
[Bluesky](https://bsky.app/intent/compose?text=I%27ve+completed+Part+One+of+%22Christmas+Tree+Farm%22+%2D+Day+12+%2D+Advent+of+Code+2025+%23AdventOfCode+https%3A%2F%2Fadventofcode%2Ecom%2F2025%2Fday%2F12){target="_blank"}
[Twitter](https://twitter.com/intent/tweet?text=I%27ve+completed+Part+One+of+%22Christmas+Tree+Farm%22+%2D+Day+12+%2D+Advent+of+Code+2025&url=https%3A%2F%2Fadventofcode%2Ecom%2F2025%2Fday%2F12&related=ericwastl&hashtags=AdventOfCode){target="_blank"}
[Mastodon](javascript:void(0);){onclick="var ms; try{ms=localStorage.getItem('mastodon.server')}finally{} if(typeof ms!=='string')ms=''; ms=prompt('Mastodon Server?',ms); if(typeof ms==='string' && ms.length){this.href='https://'+ms+'/share?text=I%27ve+completed+Part+One+of+%22Christmas+Tree+Farm%22+%2D+Day+12+%2D+Advent+of+Code+2025+%23AdventOfCode+https%3A%2F%2Fadventofcode%2Ecom%2F2025%2Fday%2F12';try{localStorage.setItem('mastodon.server',ms);}finally{}}else{return false;}"
